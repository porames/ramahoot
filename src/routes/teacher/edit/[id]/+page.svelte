...
<div class="min-h-screen p-4">
  <div class="mx-auto max-w-2xl rounded-2xl bg-white shadow-lg p-6">
    ...
    <h1 class="text-3xl font-bold text-slate-900 mt-4 mb-8">Edit Quiz</h1>
          ...
          {:else if question.type === 'tf'}
            <div class="flex gap-3 mb-4">
              <button
                ...
                class:hover:bg-slate-50={question.correctAnswerId !== 'true'}>True</button
              >
              <button
                onclick={() => (question.correctAnswerId = 'false')}
                class="flex-1 rounded-xl border-2 px-6 py-4 text-lg font-semibold transition"
                class:border-emerald-500={question.correctAnswerId === 'false'}
                class:bg-emerald-50={question.correctAnswerId === 'false'}
                ...
                class:hover:bg-slate-50={question.correctAnswerId !== 'false'}>False</button
              >
            </div>
